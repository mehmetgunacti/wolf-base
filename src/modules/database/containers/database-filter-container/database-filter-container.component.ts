...
@Component({
	selector: 'app-database-filter-container',
	templateUrl: './database-filter-container.component.html',
	styleUrls: ['./database-filter-container.component.scss'],
	changeDetection: ChangeDetectionStrategy.OnPush
})
export class DatabaseFilterContainerComponent {
