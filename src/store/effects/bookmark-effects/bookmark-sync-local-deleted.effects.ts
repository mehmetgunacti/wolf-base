...
import { selBookmarkLocalDeleted } from 'store/selectors/bookmark-selectors/bookmark-cloud.selectors';
	...
	syncLocalUpdated$ = createEffect(
		...
		() => this.actions$.pipe(
			...
			switchMap(([, entities]) =>
				...
				this.syncService.uploadDeleted(AppEntityType.bookmark, entities).pipe(
