...
import { selExam_RemoteUpdated } from '@selectors/sync/sync-exam.selectors';
...
import { selSession_RemoteUpdated } from '@selectors/sync/sync-session.selectors';
import { selTask_RemoteUpdated } from '@selectors/sync/sync-task.selectors';
import { selTestSuite_RemoteUpdated } from '@selectors/sync/sync-test-suite.selectors';
...
function useSelector(entityType: AppEntityType) {
	...
	switch (entityType) {
		...
		case AppEntityType.exam: return selExam_RemoteUpdated;
		...
		case AppEntityType.session: return selSession_RemoteUpdated;
