...
@Component({
	...
	host: {
		...
		'(click)': 'onInput()',
		'class': 'inline-flex items-center justify-between px-1 gap-2 cursor-pointer relative h-widget-height border border-transparent hover:border-outline rounded-lg focus-within:ring-4 focus-within:ring-outline outline-hidden group',
