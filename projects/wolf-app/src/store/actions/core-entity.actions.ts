...
// export const createEntitySuccess = createAction('[CORE] Create Entity Success', props<{ id: UUID, entity: WolfEntity }>());

// export const updateEntity = createAction('[CORE] Update Entity', props<{ id: UUID, entity: WolfEntity, data: Partial<Entity> }>());
// export const updateEntitySuccess = createAction('[CORE] Update Entity Success', props<{ id: UUID, entity: WolfEntity }>());
