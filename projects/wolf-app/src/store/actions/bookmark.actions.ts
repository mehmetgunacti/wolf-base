...
export const loadAllSuccess					= createAction('[Bookmark] Load All Success', props<{ bookmarks: Bookmark[] }>());

export const loadOne						= createAction('[Bookmark] Load One', props<{ id: UUID }>());
export const loadOneSuccess					= createAction('[Bookmark] Load One Success', props<{ bookmark: Bookmark }>());
export const loadOneFailure					= createAction('[Bookmark] Load One Failure', props<{ id: UUID }>());
...
export const syncLocalNewSuccess			= createAction('[Bookmark] Sync Local New Success', props<{ item: NameBase }>());

export const syncLocalUpdated				= createAction('[Bookmark] Sync Local Updated');
export const syncLocalUpdatedSuccess		= createAction('[Bookmark] Sync Local Updated Success', props<{ item: NameBase }>());
...
export const syncRemoteNewSuccess			= createAction('[Bookmark] Sync Remote New Success', props<{ item: NameBase }>());

export const syncRemoteUpdated				= createAction('[Bookmark] Sync Remote Updated');
export const syncRemoteUpdatedSuccess		= createAction('[Bookmark] Sync Remote Updated Success', props<{ item: NameBase }>());
